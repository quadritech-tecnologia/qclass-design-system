...
class AppThemes {
  ...
  static ThemeData createLightTheme() {
    final colorScheme = ColorScheme(
      ...
      tertiary: AppColorsBase.primary,
      onTertiary: AppColorsBase.primary,
      tertiaryContainer: AppColorsBase.primary,
      onTertiaryContainer: AppColorsBase.primary,
  ...
  static ThemeData createDarkTheme() {
    final colorScheme = ColorScheme(
      ...
      onTertiary: AppColorsBase.tertiary.withOpacity(.56),
      tertiaryContainer: AppColorsBase.tertiary,
      onTertiaryContainer: AppColorsBase.tertiary.withOpacity(.56),
      error: AppColorsBase.danger,
      onError: AppColorsBase.danger,
      errorContainer: AppColorsBase.danger,
      onErrorContainer: const Color(0xFFFFE1E2),
